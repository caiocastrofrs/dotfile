...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  edge = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/edge",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  ["no-neck-pain.nvim"] = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/no-neck-pain.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["tagalong.vim"] = {
    loaded = true,
    path = "/home/caio/.local/share/nvim/site/pack/packer/start/tagalong.vim",
